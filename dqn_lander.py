...
buffer_limit = 50000
batch_size = 32
# --- 수정: 에피소드 수 및 결과 출력 주기 조정 ---
num_episodes = 1000 # 원활한 테스트를 위해 에피소드 수를 1000으로 조정 (원래 50000)
print_interval = 20
...
def main():
    ...
    for n_epi in tqdm(range(num_episodes)):
        ...
        if n_epi % print_interval == 0 and n_epi != 0:
            ...
            # --- 수정: 출력 형식 변경 ---
            # 지난 print_interval 동안의 평균 점수 계산
    ...
    np.savez(os.path.join(output_dir, 'dqn_results.npz'),
